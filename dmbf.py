#!/usr/bin/python3
#-*-coding:utf-8-*-
# Made With ❤️ By LEON X DOMINO Project
# Update V0.1

# Copyright© LEON X DOMINO
# 100% Open Source Code

# Author : LEON X DOMINO
# Facebook (LEON X DOMINO)   : Facebook.com/yiaa.id
# Instagram (GA PUNYA)    : 
# Whatsapp (LEON X DOMINO)      : +6281315504328
# YouTube (XYNE DENY)           : youtube.com/channel/UCZX2xGFqe-an4Njw8x_fB3A
...
_logo_line_3_ = ('%s| |) | |\/| | _ \ _|  %s│   %s• Code By XYNE DENY •   %s│'%(_P_,_U_,_P_,_U_))
_logo_line_4_ = ('%s|___/|_|  |_|___/_|   %s│ %sgithub.com/333303/dmbf%s│'%(_P_,_U_,_P_,_U_))
_logo_line_5_ = ('%s XNSCODE Team 2022    └─────────────────────────┘'%(_U_))
def _my_logo_():
